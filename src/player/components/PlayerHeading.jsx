...
export const PlayerHeading = ({active = false, songTitle, songAuthor, songExplicit, rightActions, leftActions, textLayoutId}) => {
    return (
        <div className="w-full flex justify-center items-center gap-x-5">
            {leftActions}
            {
                textLayoutId ? (
                    ...
                    >
                        <h3 className={`text-xl${active ? ' font-semibold': ''}`}>{songTitle} {songExplicit && <i className="fa-sharp fa-solid fa-circle-exclamation opacity-60"></i>}</h3>
